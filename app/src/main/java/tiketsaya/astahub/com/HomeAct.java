...
import tiketsaya.astahub.com.Tickets.TicketPreviewDetails;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_to_profile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent goprofile = new Intent(HomeAct.this, MyProfile.class);
        ...
        btn_ticket_pisa.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent gotopisaticket = new Intent(HomeAct.this, TicketPreviewDetails.class);
