...
import tiketsaya.astahub.com.Register.Register2;
import tiketsaya.astahub.com.Register.SuccessRegister;
...
public class EditProfile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                Picasso.with(EditProfile.this).load(dataSnapshot.child("url_photo_profile")
                ...
                if (photo_location != null){
                    ...
                    storageReference.putFile(photo_location)
                        ...
                        public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task) {
                            //brpindah activity
                            Intent nextregister = new Intent(EditProfile.this, MyProfile.class);
     ...
     btn_back.setOnClickListener(new View.OnClickListener() {
         @Override
         public void onClick(View v) {
             Intent goback = new Intent(EditProfile.this, MyProfile.class);
    ...
    public void findphoto(){
        ...
        startActivityForResult(gambar, photo_max);
    }
